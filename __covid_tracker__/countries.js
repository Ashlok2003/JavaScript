...
const close_list_button = document.querySelector('.close');
...
function createCountryList() {
    ...
    country_list.forEach((country, index) => {
        ...
        // Pushing the countries into the created unique lists
...
change_country_button.addEventListener('click', () => {
    input.value = "";
    resetCountryList();
    search_country_element.classList.toggle('hide');
});

close_list_button.addEventListener('click', () => {
    search_country_element.classList.add('hide');
});

/* Sorting the countries on the basis of the user input */

input.addEventListener('input', () => {
    let value = input.value.toUpperCase();

    country_list.forEach(country => {
        ((country.name.toUpperCase().startsWith(value)) ?
            document.getElementById(country.name).classList.remove('hide') :
            document.getElementById(country.name).classList.add('hide'))
    })
})

/* Reseting the country list afterwards */
